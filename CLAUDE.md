...
| 종합 컬러 산출 | **종목 overall** = GPT 직접 도출(단순 다수결 아님, 종목 분석 응답에 포함). **포트폴리오 overall** = 4c-9 부터 클라 계산 — 8종목 overall 을 점수화(pos_strong+3…neg_strong−3, neutral 0)해 평균 후 밴드(`|s|<0.5 중립/<1.5 약/<2.5 중/≥2.5 강`). intensity 가 가중 역할. GPT 호출 0 |
